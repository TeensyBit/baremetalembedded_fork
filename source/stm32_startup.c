...
2. Startup code that initialized the .data and .bss section in SRAM
3. Call main
...
IRQs till 81
----------------------- 0x0800017C
Addr of hardfault hand  0x0800000C
----------------------- 
Addr of NMI hand        0x08000008
----------------------- 
Addr of reset hand      0x08000004
----------------------- 
Inital MSP Value        0x08000000
----------------------- 

Total Memory consumed = 82 IRQs + 15 System Exceptions + 1 MSP = 98 word addressable memory locations
                      = 98*4 = 392 bytes          
*/
